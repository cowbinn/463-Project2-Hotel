...
bathroom_checkOff = Button(window, text="Check off Bathrooms", command=bathrooms)
bathroom_checkOff.place(x=70, y=30)

towels_checkOff = Button(window, text="Check off Towels", command=towels)
towels_checkOff.place(x=70, y=60)

bedsheets_checkOff = Button(window, text="Check off Bed Sheets", command=bedsheets)
bedsheets_checkOff.place(x=70, y=90)

vacuum_checkOff = Button(window, text="Check off Vacuum", command=vacuum)
vacuum_checkOff.place(x=70, y=120)

dusting_checkOff = Button(window, text="Check off Dusting", command=dusting)
dusting_checkOff.place(x=70, y=150)

electronics_checkOff = Button(window, text="Check off Electronics", command=electronics)
electronics_checkOff.place(x=70, y=180)

all_checkOff = Button(window, text="Check off All/Make Available", command=checkAll)
all_checkOff.place(x=70, y=210)

unavailable_changeStatus = Button(window, text="Unavailable/Maintenance", command=unavailable_maintenance)
