...
def RoomAvailibity():
    ...
    window.geometry("1000x600+10+100")
    ...
    for row in range (22):
        ...
        for column in range (9):
            ...
            if row == 0 :  #day of the week
                lable0= Label(window, text="Room Number",bg="black",fg="white",padx= 3,pady=3)
                lable0.grid(row=0, column=0,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=currentDay.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=1,sticky= "nsew",padx= 1,pady=1)
                lable4 = Label(window, text=nextDay1.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable4.grid(row=0, column=2,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay2.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=3,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay3.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=4,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay4.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=5,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay5.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=6,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay6.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=7,sticky= "nsew",padx= 1,pady=1)
                lable3 = Label(window, text=nextDay7.strftime('%A'),bg="black",fg="white",padx= 3,pady=3 )
                lable3.grid(row=0, column=8,sticky= "nsew",padx= 1,pady=1)
            elif row == 1:#date
                lable2= Label(window, text=str(currentDay.month) +"/" + str(currentDay.day))
                lable2.grid(row= 1, column= 1,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window, text=str(nextDay1.month) +"/" + str(nextDay1.day))
                lable2.grid(row= 1, column= 2,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window, text=str(nextDay2.month) +"/" + str(nextDay2.day))
                lable2.grid(row= 1, column= 3,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window, text=str(nextDay3.month) +"/" + str(nextDay3.day))
                lable2.grid(row= 1, column= 4,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window, text=str(nextDay4.month) +"/" + str(nextDay4.day))
                lable2.grid(row= 1, column= 5,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window, text=str(nextDay5.month) +"/" + str(nextDay5.day))
                lable2.grid(row= 1, column= 6,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window,text=str(nextDay6.month) +"/" + str(nextDay6.day))
                lable2.grid(row= 1, column= 7,sticky= "nsew",padx= 1,pady=1)
                lable2= Label(window,text=str(nextDay7.month) +"/" + str(nextDay7.day))
                ...
                label6 = Menubutton(window,text="Available")
